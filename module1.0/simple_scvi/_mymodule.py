...
from scvi.nn import DecoderSCVI, Encoder, one_hot # https://github.com/scverse/scvi-tools/blob/1b24021a1239de48f9756575b91b190f46c11edb/src/scvi/nn/_base_components.py
...
# 11/18/24 edit note: all qz_v renamed to qzv and qz_m renamed to qzm to match scvi.module._constants.MODULE_KEYS
...
class MyModule(BaseModuleClass):
    ...
    def inference(self, x):
        ...
        qzm, qzv, z = self.z_encoder(x_) # https://github.com/scverse/scvi-tools/blob/1b24021a1239de48f9756575b91b190f46c11edb/src/scvi/nn/_base_components.py#L290 
        ql_m, ql_v, library = self.l_encoder(x_)

        outputs = dict(z=z, qzm=qzm, qzv=qzv, ql_m=ql_m, ql_v=ql_v, library=library)
        return outputs
    ...
    def sample(
        self,
        tensors,
        n_samples=1, # this parameter is not being used
        library_size=1, # note: this parameter is not being used 
    ) -> torch.Tensor:
        r"""
